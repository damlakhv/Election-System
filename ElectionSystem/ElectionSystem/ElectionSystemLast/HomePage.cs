...
namespace ElectionSystem
{
    public partial class HomePage : Form
    {
        ...
        {
            this.WindowState = FormWindowState.Maximized; // Form tam ekran açılacak
            GeneralResultPieChart();
            ParticipatinRateLineGraph();
        ...
        {
            ColorTranslator.FromHtml("#54bb52"),
            ColorTranslator.FromHtml("#bd4242"),
            ColorTranslator.FromHtml("#617bc3")  
        };
        ...
        private void ParticipatinRateLineGraph()
        {
            using (var context = new ElectionEntities())
            {
                var results = context.Election
                    ...
                    .OrderBy(result => result.Year) // SORTING YAPTIK
                    .ToList();
        ...
        private void HomaPage_Resize(object sender, EventArgs e)
        {
        }
